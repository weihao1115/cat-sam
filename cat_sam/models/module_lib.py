...
class LayerNorm2d(nn.Module):
    """
    Adapted from
    https://github.com/SysCV/sam-hq/blob/322488826bda616798901c6280d13a9a90444ae7/train/train.py#L29
    """
...
def trunc_normal_(tensor, mean=0., std=1., a=-2., b=2.):
    ...
    r"""
    Adapted from
    https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/60bd2770b1c4fcb38d98822cae9a17781601ff9e/models/mmseg/models/sam/image_encoder.py#L159
...
def _no_grad_trunc_normal_(tensor, mean, std, a, b):
    """
    Adapted from
    https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/60bd2770b1c4fcb38d98822cae9a17781601ff9e/models/mmseg/models/sam/image_encoder.py#L179
    """
...
class PromptGenerator(nn.Module):
    """
    Adapted from
    https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/60bd2770b1c4fcb38d98822cae9a17781601ff9e/models/mmseg/models/sam/image_encoder.py#L215
    """
    def __init__(self, scale_factor, prompt_type, embed_dim, tuning_stage, depth, input_type,
        ...
        Args:
        """
        assert handcrafted_tune or embedding_tune
    ...
    def get_prompt(self, handcrafted_feature, embedding_feature, hq_feature: torch.Tensor = None):
